...
import { CheckCircle, LayoutTemplate, Columns3, PanelLeft, PanelRight, AlignLeft, Users, Building2 } from "lucide-react";
        ...
        <div className="grid items-center gap-12 sm:gap-16 md:gap-20 lg:gap-24 lg:grid-cols-2 min-h-[80vh]">
          ...
          <div className="flex flex-col justify-center lg:pr-8">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
              We analyze your skills, interests, and goals to match you with the internships where you'll thrive. Discover roles tailored to your strengths and start building your career with confidence.
            </p>
    ...
    For Companies
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              <div className="flex items-center gap-2">
                <span className="inline-block size-1.5 rounded-full bg-green-500" />
                <span className="text-gray-700">Personalized role fit based on your profile</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="inline-block size-1.5 rounded-full bg-blue-500" />
                <span className="text-gray-700">Real-time market insights and trends</span>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6">
                ...
                <div className="flex items-center justify-between bg-gray-50 rounded-xl px-4 py-3 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-3 text-sm font-medium text-gray-700">Candidate Profile</span>
                  </div>
                  ...
                  <div className="col-span-2 bg-gray-50 rounded-xl p-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="text-xs text-gray-500 mb-1">Role Fit</div>
                        <div className="text-lg font-bold text-gray-900 mb-2">92%</div>
                      ...
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        ...
                        <div className="text-lg font-bold text-gray-900 mb-2">High</div>
                        <div className="h-1.5 bg-gray-200 rounded-full">
                          <div className="h-1.5 bg-blue-500 rounded-full" style={{ width: '80%' }} />
                        </div>
                      </div>
                      {/* Culture */}
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="text-xs text-gray-500 mb-1">Culture</div>
                        <div className="text-lg font-bold text-gray-900 mb-2">Strong</div>
                        <div className="h-1.5 bg-gray-200 rounded-full">
                          <div className="h-1.5 bg-purple-500 rounded-full" style={{ width: '75%' }} />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <div key={idx} className="bg-white rounded-lg p-3 shadow-sm hover:-translate-y-0.5 transition-transform group">
                        ...
                        <div className="h-1.5 bg-gray-200 rounded-full">
                          <div className="h-1.5 bg-green-500 rounded-full group-hover:w-[92%] transition-all duration-300" style={{ width: '88%' }} />
                        </div>
                      </div>
                    ))}
                  </div>
